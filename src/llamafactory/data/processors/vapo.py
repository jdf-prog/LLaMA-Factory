...
from .processor_utils import get_paligemma_token_type_ids, get_pixel_values, infer_seqlen, get_diff_label_indices
...
def _encode_pairwise_example(
    ...
    chosen_labels = np.array([IGNORE_INDEX] * len(chosen_input_ids))
    rejected_input_ids = prompt_ids + rejected_ids
    rejected_labels = np.array([IGNORE_INDEX] * len(rejected_input_ids))
...
def print_vapo_dataset_example(example: Dict[str, List[int]], tokenizer: "PreTrainedTokenizer") -> None:
